 ...
 * picker. A closed list of sane presets -- rather than free-entry number
 * input -- keeps every value a clearly labeled, valid duration ("45
 * minutes", never a bare "45" or something like "7"). Covers the range the
 * ticket calls out: short follow-ups (~10-15 min) through physicals
 * (45-60 min), with headroom above.
 */
